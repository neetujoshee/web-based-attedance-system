...
<section class="checkout-orders">
   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>your name :</span>
            <input type="text" name="name" value="<?= $user_name; ?>" placeholder="enter your name" class="box" readonly>
         </div>
         <div class="inputBox">
            <span>your number :</span>
            <input type="number" name="number" value="<?= $user_number;?>" placeholder="enter your number" class="box" required>
         </div>
         <div class="inputBox">
            <span>your email :</span>
            <input type="email" name="email" value="<?= $user_email; ?>" placeholder="enter your email" class="box" readonly>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>country :</span>
            <input type="text" name="country" value= "Nepal" class="box" readonly>
         </div>
</div>
         </div>
